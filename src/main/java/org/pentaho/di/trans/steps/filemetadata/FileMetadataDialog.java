...
/**
 */
public class FileMetadataDialog extends BaseStepDialog implements StepDialogInterface {
   ...
   */
  public FileMetadataDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
...
//  }
  ...
  public String open() {
    ...
    wLimit = new TextVar( transMeta, gDelimitedLayout, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wDefaultCharset = new ComboVar( transMeta, gDelimitedLayout, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wDelimiterCandidates = new TableView(transMeta, gDelimitedLayout, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI, colinf, candidateCount, lsMod, props);
    ...
    wEnclosureCandidates = new TableView(transMeta, gDelimitedLayout, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI, colinf, candidateCount, lsMod, props);
